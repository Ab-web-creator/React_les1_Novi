...
const Part2Assignment1f = () => {
    const filteredInventory = inventory.filter(item =>
        item.options.some(variant => variant.name === "ambiLight" && variant.applicable === true)
    );
    ...
    return (
        <>
            <h1>Part 2, assignment 1F: The list of TVs that have ambilight.</h1>
            <div>
...
export default Part2Assignment1f;
